...
const claudePluginRoot = join(root, "plugins", "fable-mcp-claude-code");
...
mkdirSync(join(claudePluginRoot, "dist"), { recursive: true });
...
cpSync(join(root, "dist", "server.bundled.mjs"), join(claudePluginRoot, "dist", "server.bundled.mjs"));
