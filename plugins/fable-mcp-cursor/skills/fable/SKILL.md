---
name: fable
description: Use when the user mentions Fable, Fable5, Feyble, フェイブル, asks for deep external planning/review, wants a quality/eval loop, or asks to check the Fable MCP setup from Cursor.
---

# Fable MCP for Cursor
...
- If you need to add Cursor-specific implementation notes, put them after the verbatim Fable output under `Fableプランからの変更点`.
