...
v0.5 以降は **Codex plugin として入れるのが推奨**です。MCP 定義、品質ループの Stop hook、SessionStart でのルーティング指示注入を plugin に同梱しています。
...
```sh
codex plugin marketplace add taiyuhiga/fable-mcp
